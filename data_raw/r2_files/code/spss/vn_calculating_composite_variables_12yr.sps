...
********** 12yr old dataset - Vietnam Version.

GET FILE='C:\Young Lives\Vietnam2\VNChildLevel12YrOld.sav'.
...
IF (floor=1 | floor=6 | floor=3) hq=hq+1.
COMPUTE hq=hq/4.
...
SAVE OUTFILE='C:\Young Lives\Vietnam2\VNChildLevel12YrOld.sav'.
