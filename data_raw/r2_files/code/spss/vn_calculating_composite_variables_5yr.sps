...
********** 5yr old dataset - Vietnam Version.

GET FILE='C:\Young Lives\Vietnam2\VNChildLevel5YrOld.sav'.
...
IF (floor=3 | floor=6  | floor=1) hq=hq+1.
COMPUTE hq=hq/4.
...
* For Vietnam2 12 assets are considered - Radio, Refrigerator, Bicycle,
...
* (drwater=03); add 1 if the household has their own toilet facility, 
...
SAVE OUTFILE='C:\Young Lives\Vietnam2\VNChildLevel5YrOld.sav'.
