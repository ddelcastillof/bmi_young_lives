...
********** 1yr old dataset - Vietnam Version.
GET FILE='C:\Young Lives\Vietnam\VNChildLevel1YrOld.sav'.
...
SAVE OUTFILE='C:\Young Lives\Vietnam\VNChildLevel1YrOld.sav' /COMPRESSED.
...
GET FILE='C:\Young Lives\Vietnam\VNSubSec2HouseholdRoster1.sav'.
ADD FILES /FILE=*
...
SORT CASES BY childid.
MATCH FILES /FILE='C:\Young Lives\Vietnam\VNChildLevel1YrOld.sav'
...
********************************************************************.
MATCH FILES /FILE=*
 /TABLE='C:\Young Lives\Vietnam\VNSubSec2HouseholdRoster1.sav'
...
SORT CASES BY childid.
SAVE OUTFILE='C:\Young Lives\Vietnam\VNChildLevel1YrOld.sav'.
...
MATCH FILES /FILE=*
 ...
 /BY childid careid
 /DROP= age d0 relate specrel still disabled support v1020511 v1020512.
EXECUTE.
...
MATCH FILES FILE=* /TABLE='C:\Young Lives\Vietnam\VNChildLevel1YrOld.sav'
...
MATCH FILES /FILE=*
 ...
 /BY childid careid
 /DROP= d0 relate specrel still yrschool d1 support v1020511 v1020512.
EXECUTE.
...
**********************************************************************************.
GET FILE='C:\Young Lives\Vietnam\VNSubSec7HHLivelihoods1.sav'.
...
MATCH FILES /FILE=*
 /RENAME  id=careid 
 /TABLE='C:\Young Lives\Vietnam\VNChildLevel1YrOld.sav'
 /BY childid careid
