...
********** 8Yr old dataset - Ethiopia Version.

GET FILE='C:\Young Lives\Ethiopia\ETChildLevel8YrOld.sav'.
...
IF (clustid=2) typesite=1.
IF (clustid=3) typesite=1.
IF (clustid=4) typesite=1.
...
* For Ethiopia 11 assets are considered - Radio, Refrigerator, Bicycle,
* Television, Motorbike/scooter, Car, Mobile phone, Landline telephone, 
* Bedsted, Table & Chair, Sofa.
...
IF (MISSING(elec) | MISSING(drwater) | MISSING(toilet) | 
 MISSING(cooking)) sv=99.
EXECUTE.
...
SAVE OUTFILE='C:\Young Lives\Ethiopia\ETChildLevel8YrOld.sav' /COMPRESSED.
...
COMPUTE id=0.
EXECUTE.
SAVE OUTFILE='C:\Young Lives\Ethiopia\temp.sav'
 /KEEP=childid id sex /COMPRESSED.

GET FILE='C:\Young Lives\Ethiopia\ETSubSec2HouseholdRoster8.sav'.
ADD FILES /FILE=*
 /FILE='C:\Young Lives\Ethiopia\temp.sav'
...
SORT CASES BY childid.
MATCH FILES /FILE='C:\Young Lives\Ethiopia\ETChildLevel8YrOld.sav'
...
********************************************************************.
MATCH FILES /FILE=*
 /TABLE='C:\Young Lives\Ethiopia\ETSubSec2HouseholdRoster8.sav'
...
SORT CASES BY childid.
SAVE OUTFILE='C:\Young Lives\Ethiopia\ETChildLevel8YrOld.sav'.
...
* For Ethiopia primary education is completed when the education level
* is 6 or higher.
...
MATCH FILES /FILE=*
 ...
 /BY childid careid
 /DROP= age d0 relate specrel still disabled support.
EXECUTE.
...
MATCH FILES FILE=* /TABLE='C:\Young Lives\Ethiopia\ETChildLevel8YrOld.sav'
...
MATCH FILES /FILE=*
 ...
 /BY childid careid
 /DROP= d0 relate specrel still yrschool support .
EXECUTE.
...
**********************************************************************************.
GET FILE='C:\Young Lives\Ethiopia\ETSubSec7HHLivelihoods8.sav'.
...
MATCH FILES /FILE=*
 /RENAME  id=careid 
 /TABLE='C:\Young Lives\Ethiopia\ETChildLevel8YrOld.sav'
 /BY childid careid
...
* The Ravens Test was only conducted in sites 1, 2, 3, 14, and 19.
* Also some children in one of these sites did not take the test.
...
DO IF ((clustid>3 & clustid<14 ) | (clustid>14 & clustid<19) | clustid=20).
COMPUTE ra1=88.
COMPUTE ra2=88.
COMPUTE ra3=88.
COMPUTE ra4=88.
...
DO IF (childid="ET011030" | childid="ET011039" | childid="ET011040" | 
 childid="ET011041" | childid="ET011042" | childid="ET011038").
COMPUTE ra1=88.
COMPUTE ra2=88.
COMPUTE ra3=88.
COMPUTE ra4=88.
