...
********** 8Yr old dataset - Peru Version.
GET FILE='C:\Young Lives\Peru\PEChildLevel8YrOld.sav'.

************************************************************************.
* In Peru the Urban/rural breakdown was by household rather than 
* by cluster.
* The Urban/Rural classification for each household is stored in a
* separate SPSS data file in a variable called 'typesite'
******************************************************************************.
MATCH FILES /FILE=*
 /TABLE='C:\Young Lives\Peru\PE8YrOldUrbanRural.sav'
 /BY childid.

RECODE typesite (SYSMIS=99).
EXECUTE.
...
* For Peru 12 assets are considered - Radio, Refrigerator, Bicycle,
* Television, Motorbike/scooter, Car, Mobile phone, Landline telephone, 
* Iron, Blender, Gas or electric cooker, Record player.
...
IF (MISSING(radio) | MISSING(fridge) | MISSING(bike) | MISSING(tv) |
 ...
 MISSING(plancha) | MISSING(licua) | MISSING(cocgas) | MISSING(tocad)) cd=99.
EXECUTE.
...
SAVE OUTFILE='C:\Young Lives\Peru\PEChildLevel8YrOld.sav' /COMPRESSED.
...
COMPUTE id=0.
EXECUTE.
SAVE OUTFILE='C:\Young Lives\Peru\temp.sav'
 /KEEP=childid id sex /COMPRESSED.

GET FILE='C:\Young Lives\Peru\PESubSec2HouseholdRoster8.sav'.
ADD FILES /FILE=*
 /FILE='C:\Young Lives\Peru\temp.sav'
 /DROP=age relate specrel still yrschool disabled support edinicia
 grado anhos.
EXECUTE.
...
SORT CASES BY childid.
MATCH FILES /FILE='C:\Young Lives\Peru\PEChildLevel8YrOld.sav'
...
********************************************************************.
MATCH FILES /FILE=*
 /TABLE='C:\Young Lives\Peru\PESubSec2HouseholdRoster8.sav'
 /RENAME (id=headid) (sex=hdsex)
 /BY childid headid
 /DROP= age disabled relate specrel still support yrschool edinicia 
 grado anhos.
EXECUTE.
...
SORT CASES BY childid.
SAVE OUTFILE='C:\Young Lives\Peru\PEChildLevel8YrOld.sav'.
...
* For Peru primary education is completed when the education level
* is 33 or higher.
...
MATCH FILES /FILE=*
 ...
 /BY childid careid
 /DROP= age d0 relate specrel still disabled support edinicia grado anhos.
EXECUTE.
...
MATCH FILES FILE=* /TABLE='C:\Young Lives\Peru\PEChildLevel8YrOld.sav'
...
MATCH FILES /FILE=*
 ...
 /BY childid careid
 /DROP= d0 relate specrel still yrschool support edinicia grado anhos.
EXECUTE.
...
**********************************************************************************.
GET FILE='C:\Young Lives\Peru\PESubSec7HHLivelihoods8.sav'.
...
MATCH FILES /FILE=*
 /RENAME  id=careid 
 /TABLE='C:\Young Lives\Peru\PEChildLevel8YrOld.sav'
 /BY childid careid
...
* 7 of the children were not interviewed
...
DO IF (childid="PE018007" | childid="PE048011" | childid="PE118008" | 
  childid="PE118026" | childid="PE118023" | childid="PE158014" | 
  childid="PE178032").
COMPUTE ra1=88.
COMPUTE ra2=88.
COMPUTE ra3=88.
