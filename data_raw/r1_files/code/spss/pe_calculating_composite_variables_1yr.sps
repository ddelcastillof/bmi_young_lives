...
********** 1yr old dataset - Peru Version.
GET FILE='C:\Young Lives\Peru\PEChildLevel1YrOld.sav'.
...
******************************************************************************.
MATCH FILES /FILE=*
 /TABLE='C:\Young Lives\Peru\PE1YrOldUrbanRural.sav'
 /BY childid.
...
SAVE OUTFILE='C:\Young Lives\Peru\PEChildLevel1YrOld.sav' /COMPRESSED.
...
GET FILE='C:\Young Lives\Peru\PESubSec2HouseholdRoster1.sav'.
ADD FILES /FILE=*
 /FILE='C:\Young Lives\Peru\temp.sav'
 /DROP=age relate specrel still yrschool disabled care support edinicia
 grado anhos.
EXECUTE.
...
SORT CASES BY childid.
MATCH FILES /FILE='C:\Young Lives\Peru\PEChildLevel1YrOld.sav'
...
********************************************************************.
MATCH FILES /FILE=*
 /TABLE='C:\Young Lives\Peru\PESubSec2HouseholdRoster1.sav'
 /RENAME (id=headid) (sex=hdsex) (care=d0)
 /BY childid headid
 /DROP= age d0 disabled relate specrel still support yrschool edinicia 
 grado anhos.
EXECUTE.
...
MATCH FILES /FILE=*
 ...
 /BY childid careid
 /DROP= age d0 disabled relate specrel still support yrschool
...
SORT CASES BY childid.
SAVE OUTFILE='C:\Young Lives\Peru\PEChildLevel1YrOld.sav'.
...
MATCH FILES FILE=* /TABLE='C:\Young Lives\Peru\PEChildLevel1YrOld.sav'
...
MATCH FILES /FILE='C:\Young Lives\Peru\PEChildLevel1YrOld.sav'
 /TABLE=* /RENAME (sex=sextemp) (age=agemum) (disabled=disabmum) (care=d1)
 /BY childid /DROP=id sextemp relate specrel still yrschool d1 support 
 edinicia grado anhos.
EXECUTE.
...
MATCH FILES /FILE=*
 ...
 /BY childid careid
 /DROP= d0 relate specrel still yrschool d1 support edinicia grado anhos.
EXECUTE.
...
**********************************************************************************.
GET FILE='C:\Young Lives\Peru\PESubSec7HHLivelihoods1.sav'.
...
MATCH FILES /FILE=*
 /RENAME  id=careid 
 /TABLE='C:\Young Lives\Peru\PEChildLevel1YrOld.sav'
 /BY childid careid
